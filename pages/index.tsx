    ...
    <div className='w-screen'>
      ...
      <div className='md:px-52 px-5'>
        <div className="flex mt-10 flex-wrap justify-center gap-5 items-center">
          <a href="https://cake-cutter.github.io/docs/1-install" target="_blank" className='flex home-links-button justify-center text-gray-800 items-center rounded-full px-7 py-3 gap-2 font-extrabold'>
          ...
          <a href="https://cake-cutter.github.io/docs/" target="_blank" className='flex home-links-button justify-center text-gray-800 items-center rounded-full px-8 py-3 gap-2 font-extrabold'>
